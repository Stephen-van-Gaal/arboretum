...
| Agent instructions | `docs/templates/CLAUDE.md` | `CLAUDE.md` / `AGENTS.md` | Cross-cutting | Operational instructions for AI sessions, workflows, testing, and git. | Framework upgrade; local process change. |
