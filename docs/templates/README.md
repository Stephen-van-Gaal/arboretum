...
| Agent workflow contract | `docs/templates/ARBORETUM.md` | `ARBORETUM.md` | Cross-cutting | Canonical common pipeline rules for every code agent: `/start`, stage handoff, review-before-build, and the verified `agent-ready` exception. | Framework upgrade; workflow contract change. |
